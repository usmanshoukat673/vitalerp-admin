...
use App\Events\BusinessPlanAssigned;
...
class AssignBusinessPlan implements ShouldQueue
{
    ...
    {
        $company = Company::find($this->comp_id);
        ...
        BusinessPlanAssigned::dispatch($this->comp_id);
    }
}
