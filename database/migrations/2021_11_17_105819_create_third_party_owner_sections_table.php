...
class CreateThirdPartyOwnerSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tpy_owner_sections', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tpy_owner_sections');
    }
}
