"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_select-org_ChangeCurrentPassword_js"],{

/***/ "./resources/js/components/select-org/ChangeCurrentPassword.js":
/*!*********************************************************************!*\
  !*** ./resources/js/components/select-org/ChangeCurrentPassword.js ***!
  \*********************************************************************/
...
/* harmony import */ var _auth_AuthHeader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../auth/AuthHeader */ "./resources/js/components/auth/AuthHeader.jsx");
...
var ChangeCurrentPassword = /*#__PURE__*/function (_Component) {
  function ChangeCurrentPassword() {
    var _this;
    _classCallCheck(this, ChangeCurrentPassword);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, ChangeCurrentPassword, [].concat(args));
    ...
    _defineProperty(_this, "handleSubmit", function (event) {
      ...
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/user/change-current-password', _this.state).then(function (response) {
        ...
        _this.props.history.push(response.data.redirect);
      })["catch"](function (err) {
  ...
  _inherits(ChangeCurrentPassword, _Component);
  return _createClass(ChangeCurrentPassword, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_auth_AuthHeader__WEBPACK_IMPORTED_MODULE_7__["default"], {
        signup: false
      ...
      }, "Change Password"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__["default"], {
        sx: {
          marginBottom: '50px',
          color: '#fff'
        }
      }, "For security reason it is import to change your password"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
        className: "",
      ...
      }), this.displayInputError(errors, 'password')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_8__["default"], {
        sx: {
          marginBottom: '15px'
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_10__["default"], {
      ...
      }), this.displayInputError(errors, 'password_confirmation')), password != '' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_password_strength_bar__WEBPACK_IMPORTED_MODULE_4__["default"], {
        password: password
