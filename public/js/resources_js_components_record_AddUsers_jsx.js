"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_record_AddUsers_jsx"],{
...
/***/ "./resources/js/components/record/AddUsers.jsx":
/*!*****************************************************!*\
  !*** ./resources/js/components/record/AddUsers.jsx ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var AddUsers = function AddUsers(_ref) {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    selected_users = _useState4[0],
    setSelectedUsers = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
    _useState6 = _slicedToArray(_useState5, 2),
    add_user = _useState6[0],
    setAddUser = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState8 = _slicedToArray(_useState7, 2),
    add_user_name = _useState8[0],
    setAddUserName = _useState8[1];
  ...
  var handleSubmit = function handleSubmit() {
    setCreating(true);
    _api_api__WEBPACK_IMPORTED_MODULE_3__["default"].post("/api/user/records/users/add", {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_4__["default"], {
  ...
  }, !add_user && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_FormControl__WEBPACK_IMPORTED_MODULE_5__["default"], {
    fullWidth: true,
    sx: {
      m: 1
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", {
    htmlFor: "add_user_name"
  }, "Select User:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Select__WEBPACK_IMPORTED_MODULE_6__["default"], {
    id: "user",
    size: "small",
    multiple: true,
    value: selected_users,
    onChange: function onChange(e) {
      return setSelectedUsers(e.target.value);
    },
    ...
    renderValue: function renderValue(selected) {
      return selected.map(function (id) {
        var userFound = users.find(function (us) {
          return us.user_id === id;
        });
        return "".concat(userFound.user.first_name, " ").concat(userFound.user.last_name);
      }).join(', ');
    }
  }, _.map(users, function (us) {
    return !idExists(record_details.users, 'user_id', us.user_id, question_id) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_MenuItem__WEBPACK_IMPORTED_MODULE_8__["default"], {
      key: "user_".concat(us.user_id),
      value: us.user_id
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Checkbox__WEBPACK_IMPORTED_MODULE_9__["default"], {
      checked: selected_users.indexOf(us.user_id) > -1
      ...
      primary: "".concat(us.user.first_name, " ").concat(us.user.last_name)
    }));
  })), _.size(selected_users) > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", {
    style: {
      color: '#ccc'
    }
  }, "Click here to add new User") : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Link__WEBPACK_IMPORTED_MODULE_11__["default"], {
    className: "chand",
    underline: "none",
    onClick: function onClick() {
      return setAddUser(true);
    }
  }, "Click here to add new User")), add_user && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_FormControl__WEBPACK_IMPORTED_MODULE_5__["default"], {
    fullWidth: true,
    sx: {
      m: 1
    }
    ...
    htmlFor: "add_user_name"
  }, "User First & Last Name:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_TextField__WEBPACK_IMPORTED_MODULE_12__["default"], {
    id: "",
    size: "small",
    label: "Add New",
    name: "add_user_name",
    value: add_user_name,
    onChange: function onChange(e) {
      return setAddUserName(e.target.value);
    }
  ...
  }, "Click here to select existing user"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Box__WEBPACK_IMPORTED_MODULE_4__["default"], {
    sx: {
      display: 'flex',
      flexWrap: 'wrap',
      m: 1
