"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_onboarding_Assets_VerifyDeparmentAssets_jsx"],{

/***/ "./resources/js/components/onboarding/Assets/AddDeparmentAsset.jsx":
/*!*************************************************************************!*\
  !*** ./resources/js/components/onboarding/Assets/AddDeparmentAsset.jsx ***!
  \*************************************************************************/
...
var AddDeparmentAsset = function AddDeparmentAsset(_ref) {
  var build_id = _ref.build_id,
    deparment_id = _ref.deparment_id,
    added = _ref.added,
    asset_type = _ref.asset_type,
  ...
  var handleSubmit = function handleSubmit() {
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].post("/api/auth/onboarding/add-business-asset", {
      build_id: build_id,
      name: name,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AddDeparmentAsset);

/***/ }),

/***/ "./resources/js/components/onboarding/Assets/AssetExample.jsx":
/*!********************************************************************!*\
  !*** ./resources/js/components/onboarding/Assets/AssetExample.jsx ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var AssetExample = function AssetExample(_ref) {
  ...
  var toggleExamples = function toggleExamples(enpoint, object) {
    setLoading(true);
    var url = "/api/auth/onboarding/asset-example/".concat(enpoint);
  ...
  var handleAddExample = function handleAddExample(e, _ref3) {
    ...
    setErrors([]);
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/api/auth/onboarding/asset-example/add-new', {
      name: value,
      build_asset_id: asset.id,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AssetExample);

/***/ }),

/***/ "./resources/js/components/onboarding/Assets/CustomDeparmentAsset.jsx":
/*!****************************************************************************!*\
  !*** ./resources/js/components/onboarding/Assets/CustomDeparmentAsset.jsx ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _AssetExample__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AssetExample */ "./resources/js/components/onboarding/Assets/AssetExample.jsx");
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var CustomDeparmentAsset = function CustomDeparmentAsset(_ref) {
  var asset = _ref.asset,
  ...
  var handleUpdate = function handleUpdate() {
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("/api/auth/onboarding/update-business-asset", {
      id: asset.id,
      name: name
    }).then(function (e) {
      setLoading(false);
  ...
  var handleDelete = function handleDelete() {
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("/api/auth/onboarding/delete-business-asset", {
      id: asset.id
    }).then(function (e) {
      setLoading(false);
      setErrors([]);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    color: "error",
    variant: "contained"
  }, "Delete"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AssetExample__WEBPACK_IMPORTED_MODULE_4__["default"], {
    asset: asset
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CustomDeparmentAsset);

/***/ }),

/***/ "./resources/js/components/onboarding/Assets/DeparmentAsset.jsx":
/*!**********************************************************************!*\
  !*** ./resources/js/components/onboarding/Assets/DeparmentAsset.jsx ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var DeparmentAsset = function DeparmentAsset(_ref) {
  ...
  var handleChange = function handleChange(event) {
    ...
    setResponded(true);
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_5__["default"].post("/api/auth/onboarding/select-business-asset", {
      id: activity.id,
      included: status
    }).then(function (e) {
      setLoading(false);
  ...
  })), included && responded && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AssetExample__WEBPACK_IMPORTED_MODULE_4__["default"], {
    asset: activity
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DeparmentAsset);

/***/ }),

/***/ "./resources/js/components/onboarding/Assets/VerifyDeparmentAssets.jsx":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/onboarding/Assets/VerifyDeparmentAssets.jsx ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_notifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-notifications */ "./node_modules/react-notifications/lib/index.js");
/* harmony import */ var _DeparmentAsset__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DeparmentAsset */ "./resources/js/components/onboarding/Assets/DeparmentAsset.jsx");
...
/* harmony import */ var _CustomDeparmentAsset__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CustomDeparmentAsset */ "./resources/js/components/onboarding/Assets/CustomDeparmentAsset.jsx");
/* harmony import */ var _AddDeparmentAsset__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AddDeparmentAsset */ "./resources/js/components/onboarding/Assets/AddDeparmentAsset.jsx");
...
var VerifyDeparmentAssets = function VerifyDeparmentAssets(_ref) {
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    _useState8 = _slicedToArray(_useState7, 2),
    custom_assets = _useState8[0],
    setCustomAssets = _useState8[1];
  ...
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    ...
    asset_page = _useState18[0],
    setAssetPage = _useState18[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!lodash__WEBPACK_IMPORTED_MODULE_5___default().isEmpty(build_id)) {
      setLoading(true);
      axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/api/auth/onboarding/depts-assets/".concat(build_id, "/").concat(standard_id, "?page=").concat(current_page)).then(function (e) {
        setPrevPageUrl(e.data.prev_page_url);
        setNextPageUrl(e.data.next_page_url);
        setAssetPage(e.data.data[0]);
        setLoading(false);
        setErrors([]);
        setAssets(lodash__WEBPACK_IMPORTED_MODULE_5___default().filter(e.data.data[0].assets, function (funct) {
          return funct.custom == 0;
        }));
        setCustomAssets(lodash__WEBPACK_IMPORTED_MODULE_5___default().filter(e.data.data[0].assets, function (funct) {
  ...
  var handleAddCustomAsset = function handleAddCustomAsset(activity) {
    setCustomAssets([].concat(_toConsumableArray(custom_assets), [activity]));
  };
  var handleDeleteAsset = function handleDeleteAsset(activity) {
    var the_custom_assets = JSON.parse(JSON.stringify(custom_assets));
    lodash__WEBPACK_IMPORTED_MODULE_5___default().remove(the_custom_assets, function (act) {
  ...
  var handleNext = function handleNext(event) {
    if (next_page_url != null) {
      ...
      history.push("/verify-department-assets/".concat(build_id, "/").concat(standard_id, "?page=").concat(pageNumber));
    } else {
      history.push("/verify-suppliers/".concat(build_id, "/").concat(standard_id, "?page=1"));
    }
  };
  ...
  }, "Verify the Business ", asset_page.title, " Assets"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", null, lodash__WEBPACK_IMPORTED_MODULE_5___default().size(assets) > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_8__["default"], {
    sx: {
      padding: '0px 10px 15px 10px'
    }
  }, lodash__WEBPACK_IMPORTED_MODULE_5___default().map(assets, function (funct) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_DeparmentAsset__WEBPACK_IMPORTED_MODULE_2__["default"], {
      key: funct.id,
      activity: funct,
  ...
  }, "Please verify key business assets before continuing "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_8__["default"], {
    sx: {
      padding: '15px 10px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__["default"], {
  ...
  }, "Add Missing ", asset_page.title, " Assets"), lodash__WEBPACK_IMPORTED_MODULE_5___default().map(custom_assets, function (activity) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_CustomDeparmentAsset__WEBPACK_IMPORTED_MODULE_3__["default"], {
      delete_asset: handleDeleteAsset,
      key: activity.id,
      asset: activity
    });
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AddDeparmentAsset__WEBPACK_IMPORTED_MODULE_4__["default"], {
    added: handleAddCustomAsset,
    asset_type: asset_page.key,
    standard_id: standard_id,
    deparment_id: asset_page.id,
    build_id: build_id
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VerifyDeparmentAssets);
