"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_applications_Freshdesk_Freshdesk_js"],{

/***/ "./resources/js/components/applications/Freshdesk/Freshdesk.js":
/*!*********************************************************************!*\
  !*** ./resources/js/components/applications/Freshdesk/Freshdesk.js ***!
  \*********************************************************************/
...
var Freshdesk = /*#__PURE__*/function (_Component) {
  function Freshdesk() {
    var _this;
    _classCallCheck(this, Freshdesk);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, Freshdesk, [].concat(args));
    ...
    _defineProperty(_this, "handleSubmit", function (event) {
      ...
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/user/applications/freshdesk/save-settings', {
        api_key: api_key,
        ...
        return react_notifications__WEBPACK_IMPORTED_MODULE_1__.NotificationManager.success('Freshdesk connected successfully!', 'Success');
      })["catch"](function (err) {
    ...
    _defineProperty(_this, "handleFinish", function () {
      ...
      var application = _this.props.application;
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/user/applications/freshdesk/finish-setup', {
        integration_id: application.integration_id
      }).then(function (e) {
        _this.setState({
          errors: [],
  ...
  _inherits(Freshdesk, _Component);
  return _createClass(Freshdesk, [{
    ...
    value: function componentDidMount() {
      ...
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/user/applications/freshdesk/get-settings').then(function (e) {
        if (e.data.app != null) {
          _this2.setState({
            api_key: e.data.app.api_key,
            domain_name: e.data.app.domain_name,
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        ...
        className: "heading"
      }, "Freshdesk Settings")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        style: {
