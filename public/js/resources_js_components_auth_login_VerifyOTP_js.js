(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_auth_login_VerifyOTP_js"],{

/***/ "./resources/js/components/auth/login/VerifyOTP.js":
/*!*********************************************************!*\
  !*** ./resources/js/components/auth/login/VerifyOTP.js ***!
  \*********************************************************/
...
/* harmony import */ var react_cookie__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! react-cookie */ "./node_modules/react-cookie/es6/Cookies.js");
...
var VerifyOTP = /*#__PURE__*/function (_Component) {
  function VerifyOTP(props) {
    var _this;
    _classCallCheck(this, VerifyOTP);
    _this = _callSuper(this, VerifyOTP, [props]);
    ...
    _defineProperty(_this, "setID", function () {
      var _this$props$match$par = _this.props.match.params,
        token = _this$props$match$par.token,
        unique_id = _this$props$match$par.unique_id;
      if (!lodash_isempty__WEBPACK_IMPORTED_MODULE_4___default()(token) && _this.state.id !== token) {
        _this.setState({
          id: token
        });
      }
    ...
    _defineProperty(_this, "handleSubmit", function (event) {
      ...
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/auth/verify-otp', _this.state).then(function (response) {
        if (remember_me === true) {
          var cookies = _this.props.cookies;
          cookies.set("__CJMFAREMB__".concat(_this.state.unique_id), true, {
            path: '/',
        ...
        if (redirect) {
          ...
          _this.props.history.push('/user/change-password');
        } else if (response.data.pwd_rotaion.pwd_warning === 2) {
          _this.props.history.push('/user/password-expired');
        } else {
    ...
    _defineProperty(_this, "handleResendVerificationCode", function (event) {
      ...
      var token = _this.props.token;
      _api_api__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/auth/resend-otp', _this.state).then(function (response) {
        _this.setState({
          errors: [],
          resend_loading: false
        });
        var params = new URLSearchParams(_this.props.location.search);
        var redirect = params.get('redirect');
        _this.props.history.push("/verify-otp/".concat(response.data.id, "/").concat(_this.state.unique_id).concat(!lodash_isempty__WEBPACK_IMPORTED_MODULE_4___default()(redirect) ? "?redirect=".concat(redirect) : ''));
      })["catch"](function (err) {
  ...
  _inherits(VerifyOTP, _Component);
  return _createClass(VerifyOTP, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["default"], {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_lab__WEBPACK_IMPORTED_MODULE_11__["default"], {
        type: "submit",
        size: "large",
        sx: {
          paddingRight: '40px',
        ...
        variant: "contained"
      }, "Verify"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__["default"], {
        type: "button",
        size: "large",
...
_defineProperty(VerifyOTP, "propTypes", {
  cookies: (0,prop_types__WEBPACK_IMPORTED_MODULE_13__.instanceOf)(react_cookie__WEBPACK_IMPORTED_MODULE_14__["default"]).isRequired
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(mapStateToProps, {
  setUser: _actions__WEBPACK_IMPORTED_MODULE_2__.setUser,
  clearUser: _actions__WEBPACK_IMPORTED_MODULE_2__.clearUser,
  setToken: _actions__WEBPACK_IMPORTED_MODULE_2__.setToken,
  clearToken: _actions__WEBPACK_IMPORTED_MODULE_2__.clearToken,
  setCompanies: _actions__WEBPACK_IMPORTED_MODULE_2__.setCompanies,
  setPWDRotation: _actions__WEBPACK_IMPORTED_MODULE_2__.setPWDRotation,
  setMaturityLevels: _actions__WEBPACK_IMPORTED_MODULE_2__.setMaturityLevels,
...
})((0,react_cookie__WEBPACK_IMPORTED_MODULE_15__["default"])(VerifyOTP)));
