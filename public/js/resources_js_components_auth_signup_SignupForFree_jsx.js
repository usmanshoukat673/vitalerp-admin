"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_auth_signup_SignupForFree_jsx"],{

/***/ "./resources/js/components/auth/signup/SignupForFree.jsx":
/*!***************************************************************!*\
  !*** ./resources/js/components/auth/signup/SignupForFree.jsx ***!
  \***************************************************************/
...
var SignupForFree = function SignupForFree(_ref) {
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    setErrors([]);
    setLoading(true);
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/api/auth/signup-for-free', {
      email: email
    }).then(function (e) {
      history.push("/signup-for-free/verify/".concat(email));
    })["catch"](function (err) {
      setLoading(false);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_AuthHeader__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  }, "Say goodbye to manual GRC tasks and hello to automation.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__["default"], {
    sx: {
      flex: '0.5',
      padding: '20px',
      borderRadius: '6px',
    ...
    variant: "h4"
  }, "Signup For Free"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_6__["default"], {
    sx: {
      marginBottom: '50px'
    }
  }, "Please enter your email address."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", {
    ...
    name: "email",
    value: email,
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(handlerInputError(errors, 'email'), 'build__input')
  }), displayInputError(errors, 'email')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_mui_lab__WEBPACK_IMPORTED_MODULE_8__["default"], {
    type: "submit",
    size: "large",
    sx: {
      paddingRight: '40px',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SignupForFree);
