"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_compliance_ComplianceStackDashboard_jsx"],{

/***/ "./resources/js/components/compliance/ComplianceStackDashboard.jsx":
/*!*************************************************************************!*\
  !*** ./resources/js/components/compliance/ComplianceStackDashboard.jsx ***!
  \*************************************************************************/
...
/* harmony import */ var semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! semantic-ui-react */ "./node_modules/semantic-ui-react/dist/es/collections/Grid/Grid.js");
...
/* harmony import */ var _dashboard_VisitDashboardBreadcrum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../dashboard/VisitDashboardBreadcrum */ "./resources/js/components/dashboard/VisitDashboardBreadcrum.jsx");
/* harmony import */ var _LoadingBackgrop__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../LoadingBackgrop */ "./resources/js/components/LoadingBackgrop.jsx");
...
var ControlsInfoChart = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.lazy(function () {
  return __webpack_require__.e(/*! import() */ "resources_js_components_compliance_cc-category_ControlsInfoChart_js-_cb6f0").then(__webpack_require__.bind(__webpack_require__, /*! ./cc-category/ControlsInfoChart */ "./resources/js/components/compliance/cc-category/ControlsInfoChart.js"));
});
...
var ComplianceStackDashboard = function ComplianceStackDashboard(_ref) {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    all_standards = _useState6[0],
    setAllStandards = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('All'),
    _useState8 = _slicedToArray(_useState7, 2),
    type = _useState8[0],
    setStandardType = _useState8[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.openSubLeftNave)());
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.changeSidebarType)('fixed'));
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.changePageAreaState)('non-focused'));
    dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.toggleTreeViewArea)({
      open: false,
      type: ''
    }));
  }, []);
  ...
  var filter_controls = function filter_controls(controls, column, status) {
    return lodash__WEBPACK_IMPORTED_MODULE_5___default().size(lodash__WEBPACK_IMPORTED_MODULE_5___default().filter(controls, function (ap_controls) {
      return ap_controls[column] === status;
    }));
  };
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    setLoading(true);
    var stds = lodash__WEBPACK_IMPORTED_MODULE_5___default().map(standards, function (std) {
      return std.standard_id;
    });
    if (lodash__WEBPACK_IMPORTED_MODULE_5___default().size(stds) > 0) {
      _api_api__WEBPACK_IMPORTED_MODULE_1__["default"].post("/api/user/compliance/standards-info-all-new", {
        standards: stds,
        type: type,
        comp_id: company.id
      }).then(function (e) {
  ...
  var navigateStandard = function navigateStandard(standard) {
    setMoving(true);
    var std = lodash__WEBPACK_IMPORTED_MODULE_5___default().filter(standards, function (std) {
      return std.standard_id == standard.id;
    });
    _api_api__WEBPACK_IMPORTED_MODULE_1__["default"].post("/api/user/compliance/parent-sections", {
      standards: [standard.id]
    }).then(function (e) {
      if (!lodash__WEBPACK_IMPORTED_MODULE_5___default().isEmpty(std)) {
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.selectStandard)(std[0]));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.setParentSections)(e.data.parent_sections));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.setCompanyUsers)(e.data.users));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.setDetailsPanelType)('standard'));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.closeSubLeftNav)());
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.toggleTreeViewArea)({
          open: true,
          type: 'cs'
        }));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.changeSidebarType)('condensed'));
        dispatch((0,_actions__WEBPACK_IMPORTED_MODULE_4__.changePageAreaState)('focused'));
        setMoving(false);
        history.push("/".concat(company.slug, "/compliance-stack/").concat(standard.slug));
      } else {
        react_notifications__WEBPACK_IMPORTED_MODULE_2__.NotificationManager.error('UI Error, Please contact customer support.', 'Error');
      }
    })["catch"](function (err) {
      setMoving(false);
    });
  };
  var handleTypeChange = function handleTypeChange(event, _ref2) {
    var value = _ref2.value;
    setStandardType(value);
  };
  var handlePriorityChanged = function handlePriorityChanged(priority, standard_id) {
    var index = lodash__WEBPACK_IMPORTED_MODULE_5___default().findIndex(all_standards, function (std) {
      return std.id === standard_id;
    });
    var __local_std = _toConsumableArray(all_standards);
    __local_std[index].comp_std_priority.priority = priority;
    setAllStandards(__local_std);
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, loading && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_LoadingBackgrop__WEBPACK_IMPORTED_MODULE_7__["default"], {
    open: loading
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_dashboard_VisitDashboardBreadcrum__WEBPACK_IMPORTED_MODULE_6__["default"], null), " ", ' > ', " Compliance"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "cc__header"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "__name"
  }, "Compliance Stack"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "__actions"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "__filter"
    ...
    doubling: true,
    columns: 1
  }, moving && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_LoadingBackgrop__WEBPACK_IMPORTED_MODULE_7__["default"], {
    open: moving
  }), lodash__WEBPACK_IMPORTED_MODULE_5___default().map(all_standards, function (standard) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["default"].Column, {
      key: standard.id,
      className: ""
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      ...
      onClick: function onClick() {
        return navigateStandard(standard);
      }
      ...
      type: "controls",
      series: [standard.chart_info.implemented_ctrls, standard.chart_info.partially_imple_ctrls, standard.chart_info.applicable_ctrls, standard.chart_info.excluded_ctrls, standard.chart_info.not_applicable_ctrls]
    }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      ...
      className: "n__fullyimpl __count"
    }, standard.chart_info.implemented_ctrls), " Implemented"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
      className: "n__partimpl __count"
    }, standard.chart_info.partially_imple_ctrls), " Partially Implemented"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
      className: "n__applicable __count"
    }, standard.chart_info.applicable_ctrls), " Not Implemented"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
      className: "n__requiredatten __count"
    }, standard.chart_info.excluded_ctrls), " Excluded"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
      className: "n__not_applicable __count"
    }, standard.chart_info.not_applicable_ctrls), " Not Applicable")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "__totaldocs"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "__numberof_docs"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "__count"
    }, standard.documents_count), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "Documents"))))));
  })))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ComplianceStackDashboard);
