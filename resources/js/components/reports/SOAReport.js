...
import DownloadSOAReport from './DownloadSOAReport';
import './SOAReport.scss';

class SOAReport extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className="report__tile_soa">
                    <div className='__tile__header'>
                        <div className='__title'>Statement of Applicability</div>
                    </div>
                ...
                {
                    generate && <DownloadSOAReport company={company} token={token} standard={selected_standard} open={generate} close={this.handleClose} />
                }
            </React.Fragment>
        );
    }
