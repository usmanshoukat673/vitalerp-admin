...
class Task extends Component {
    ...
    handleSubmit = () => {
        ...
        const { company, sub_tasks } = this.props;

        const { title, overview, due_date, priority, assign_to, files, controls, documents } = this.state;
    ...
    render() {
        ...
        const { users, company, sub_tasks } = this.props;
        const { title, errors, all_controls, loading, overview, due_date, priority, assign_to, controls, all_documents, documents, add_sub_task } = this.state;
        ...
        return (
            <div className='__Details'>
                ...
                {
                    add_sub_task && <SubTask added={this.handleSubTaskAdded} close={() => { this.setState({ add_sub_task: false }) }} users={users} open={add_sub_task} />
                }
            </div>
