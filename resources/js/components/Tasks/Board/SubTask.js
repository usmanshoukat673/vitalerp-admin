...
const SubTask = ({ users, added, close, priorityOptions }) => {
    ...
    return (
        <div className='__the_SubTask'>
            ...
            <Form.Group>
                <Form.Field>
                    <Button type='button' onClick={() => handleSubSubmit(false)} className='btn btn-success btn-md mt-2'>Save</Button>
                    <Button type='button' onClick={() => handleSubSubmit(true)} className='btn btn-warning btn-md mt-2'>Save & Add More</Button>
                </Form.Field>
