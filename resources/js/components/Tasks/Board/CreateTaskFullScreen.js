...
const CreateTaskFullScreen = ({ leftnav, token, company, projects, users, history, sub_tasks, list_types, setSubTasks, setTaskListTypes, match, location }) => {
    ...
    return (
        <>
            ...
            <Row className='__CreateTaskFullScreen'>
                <Col xxl={8} xl={7}>
                    <Card>
                        <Card.Body>
                            <Row>
...
export default withRouter(connect(mapStateToProps, { setSubTasks, setTaskListTypes })(CreateTaskFullScreen));
