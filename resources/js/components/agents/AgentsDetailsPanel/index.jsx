...
const AgentsDetailsPanel = ({ history, match }) => {
    ...
    const { details_panel_type, category, parent_asset, sub_asset } = useSelector((state) => ({
    ...
    useEffect(() => {
        ...
        const expectedPath = `/agents/:category`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/agents/:category/:parent_asset`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/agents/:category/:parent_asset/:child_asset`;
    ...
    const handleLanParentAssetNav = () => {
        ...
        history.push(`/agents/${category.slug}/${parent_asset.id}`);
    }

     const handleLanCategoryNav = () => {
        dispatch(selectLanDetailsPanelType('category'));
        history.push(`/agents/${category.slug}`);
    }
...
export default withRouter(AgentsDetailsPanel);