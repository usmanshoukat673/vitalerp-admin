...
// type VendorTopbarSearchProps = {};

const VendorTopbarSearch = (props) => {
    const options = [
    ...
    return (
        <div className='__TopbarSearch'>
            {
                !_.isEmpty(props.shared_company.logo) && <img src={props.shared_company.logo} alt={props.shared_company.name} height="30" />
            }
...
export default VendorTopbarSearch;
