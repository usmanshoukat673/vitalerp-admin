...
const GrcForms = ({history}) => {
    ...
    return (<div className='grc__froms'>
        <PageTitle
            breadCrumbItems={[
                { label: 'Forms', path: `/beta-form/welcome` },
                { label: 'Welcome', path: `/beta-form/welcome`, active: true },
            ]}
...
export default withRouter(GrcForms);
