...
const Disclosure = ({ history }) => {
    ...
    return (<div className='grc__froms'>
        <PageTitle
            breadCrumbItems={[
                { label: 'Forms', path: `/beta-form/disclosure` },
                { label: 'Welcome', path: `/beta-form/disclosure`, active: true },
            ]}
            title={'Disclosure'}
        />
...
export default withRouter(Disclosure);
