...
class EditLocation extends Component {
    ...
    componentDidMount() {
        ...
        if(_.isEmpty(location.timezone))
        {
    ...
    handleSubmit = event => {
        ...
        axiosInstance.post('/api/user/locations/save-location-changes', {
            ...
            .then(e => {
                ...
                this.props.edited(e.data.location);

                NotificationManager.success('Location has been successfully updated!', 'Success');
            ...
            .catch(err => {
                ...
                if (err.response.status === 422) {
                    ...
                    this.setState({ errors: this.state.errors.concat(errors), loading: false, touched: false });
    ...
    render() {
        ...
        const {
            ...
            errors,
            country_options,
            name, address, city, state, country, postal_code, timezone, touched
                ...
                <Modal.Content className="add__location_modal_container">
                    ...
                    <div className="__ap__form">
                        <Form>
                            ...
                            <Form.Field>
                                <Button fluid disabled={loading || !touched} className={loading ? '__ap__action loading' : '__ap__action'} onClick={this.handleSubmit} >
                                    Submit
                                </Button>
                            </Form.Field>
                        </Form>
