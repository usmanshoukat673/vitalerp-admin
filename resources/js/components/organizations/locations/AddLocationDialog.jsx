...
const AddLocationDialog = ({ open, close, tz_list, added }) => {
    ...
    const handleSubmit = () => {
        setLoading(true);
        axiosInstance.post('/api/user/locations/add-location', formData)
            .then(e => {
                setFormData({
                    email: '',
                    name: '',
