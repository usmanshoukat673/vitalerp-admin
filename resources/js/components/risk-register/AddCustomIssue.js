...
import './AddCustomIssue.scss';
import axiosInstance from '../../api/api';

class AddCustomIssue extends Component {
    ...
    handleSubmit = event => {
        ...
        axiosInstance.post('/api/user/riskregister/add/custom/issue', this.state)
            .then(e => {
                this.setState({
                    errors: [],
                    loading: false
                });
                this.props.handleAddIssue(e.data.issue);
