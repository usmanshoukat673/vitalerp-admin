...
class Freshdesk extends Component {
    ...
    componentDidMount() {
        ...
        axiosInstance.post('/api/user/applications/freshdesk/get-settings')
            .then(e => {
    ...
    handleSubmit = event => {
        ...
        axiosInstance.post('/api/user/applications/freshdesk/save-settings', {
            api_key: api_key,
            ...
            .then(e => {
                ...
                return NotificationManager.success('Freshdesk connected successfully!', 'Success');
            })
            .catch(err => {
                if (err.response.status === 500) {
                    this.setState({ errors: [], loading: false, touched: false });
                        ...
                        <Card.Group itemsPerRow={2}>
                                ...
                                <Card.Content style={{ overflow: 'auto' }}>
                                    ...
                                    <Form>
                                        ...
                                        <Form.Group>
                                            ...
                                            <Form.Field width={8}>
                                                <p style={{ marginTop: '30px', fontSize: '16px' }}>.freshdesk.com</p>
                                            </Form.Field>
                                        </Form.Group>
                                        ...
                                        <Form.Group>
                                            <Form.Field>
                                                ...
                                                {change_domain ? <Message style={{ display: 'block' }} warning>
                                                    Changing domain name will wipe out all your existing freshdesk data from {GlobalAppName} & it can not be recovered.
                                                </Message> : ''}
                                    ...
                                    <div>
                                        <Step.Group ordered>
                                            ...
                                            {connected && expired === 0 ? <Step completed>
                                                <Step.Content>
                                            ...
                                            {configured && expired === 0 ? <Step completed>
                                                <Step.Content>
                                                    <Step.Title>Finished</Step.Title>
                                                    <Step.Description>You have successfully configured Freshdesk.</Step.Description>
                                                </Step.Content>
                                            </Step> : <Step active>
                                                <Step.Content>
                                                    <Step.Title>Finish</Step.Title>
                                                    <Step.Description>Click finish to complete Freshdesk setup</Step.Description>
                                                </Step.Content>
                                            </Step>}
                            ...
                            <Card>
                                <Card.Content>
                                    ...
                                    <p>
                                        You will need to have or create account at <a target="_blank" href="https://freshdesk.com/">https://freshdesk.com</a> to be able to use Freshdesk into {GlobalAppName} Platform.
                                    </p>

                                    <Header as="h5">Where can I find my API key?</Header>

                                    <p>1. Log in to your Freshdesk Support Portal</p>
                                    ...
                                    <p>
                                        Freshdesk assign your company a special sub-domain, When you login to your Freshdesk support portal, you should get redirect to the same.
                                    </p>

                                    <p>You can easily grab sub domain from the URL for example, <span style={{ color: '#33a2f7' }}>https://<b>example</b>.freshdesk.com</span> here <b>example</b> is compnay your domain name.</p>

                                    <Header as="h5">Enable Skip Mandatory Fields option.</Header>

                                    <p>Make sure you enable creating tickeing wihout freshdesk required fields, You can use below steps find this setting:  </p>
                                    <p>1. Log in to your Freshdesk Support Portal (You should be an Admin)</p>
                                    ...
                                    <p>This setting is required for paid freshdesk accounts only, when you have your creaed own custom required fields.</p>
...
export default connect(mapStateToProps, { closeSubLeftNav, selectControlFunction, selectCatalogSection })(Freshdesk);
