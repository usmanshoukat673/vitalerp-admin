...
const BuildSupplier = ({ activity }) => {
    ...
    const handleChange = (event) => {
        ...
        setResponded(true);
        setLoading(true);
        axios.post(`/api/auth/onboarding/select-build-supplier`, {
            id: activity.id,
            included: status,
        })
            .then(e => {
    ...
    return (
        <Box sx={{ marginBottom: '10px' }}>
            ...
            {
                (included && responded) &&  <BuildSupplierExample asset={activity} />
            }
        </Box>
    )
}

export default BuildSupplier;