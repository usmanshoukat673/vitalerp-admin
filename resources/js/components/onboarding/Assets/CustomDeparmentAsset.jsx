...
const CustomDeparmentAsset = ({ asset, delete_asset }) => {
    ...
    const handleUpdate = () => {
        setLoading(true);
        axios.post(`/api/auth/onboarding/update-business-asset`, {
            id: asset.id,
            name: name,
        })
            .then(e => {
    ...
    const handleDelete = () => {
        setLoading(true);
        axios.post(`/api/auth/onboarding/delete-business-asset`, {
            id: asset.id,
        })
            .then(e => {
                setLoading(false);
    ...
    return (
        <Box sx={{padding: '10px', border: '1px solid #ccc', marginBottom: '10px', borderRadius: '6px'}}>
            ...
            <AssetExample asset={asset} />
        </Box>
    )
}

export default CustomDeparmentAsset;