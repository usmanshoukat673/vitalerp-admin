...
import { selectLanAssets, setCompanyLocations, setCompanyTeams, setCompanyUsers, toggleCreateRecord } from "../../actions";
...
const CreateHardwareRecord = ({ pushRecordInTree }) => {
    ...
    const [resposinble_user_team, setResponsibleUserTeam] = useState('');
    const [add_responsible_user_team, setAddResponsibleUserTeam] = useState(false);
    const [responsible_user_or_team, setResponsibleUserOrTeam] = useState('');
    const [responsible_user_or_team_name, setResponsibleUserOrTeamName] = useState('');
    ...
    const [add_software, setAddSoftware] = useState(false);
    const [add_software_name, setAddSoftwareName] = useState('');
    ...
    const handleSubmit = () => {
        ...
        axiosInstance.post(`/api/user/records/add`, {
            ...
            resposinble_user_team,
            add_responsible_user_team,
            responsible_user_or_team,
            responsible_user_or_team_name,
            hd_locations,
            add_location,
            add_location_name,
            softwares,
    ...
    return (
        <Box sx={{ display: 'flex', flexWrap: 'wrap', margin: '0px 15px' }}>
            ...
            <div style={{ display: 'flex', width: '100%' }}>
                ...
                <FormControl fullWidth sx={{ m: 1 }}>
                    <label htmlFor="type">What Type of Asset Is This?</label>
                    <Select
                        id="type"
                        value={type}
            ...
            <FormControl fullWidth sx={{ m: 1 }}>
                <label htmlFor="description">Describe the purpose of this hardware?</label>
                <TextField
                    id="description"
                    multiline
                    rows={2}
            ...
            <div style={{ display: 'flex', width: '100%' }}>
                <FormControl fullWidth sx={{ m: 1 }}>
                    <label htmlFor="manufacturer">Who Is the Manufacturer of the Asset?</label>
                    <TextField
                        id="manufacturer"
                        size="small"
                ...
                <FormControl fullWidth sx={{ m: 1 }}>
                    <label htmlFor="model_number">What Is the Model Number of the Asset?</label>
                    <TextField
                        id="model_number"
                        size="small"
...

            {
                !add_vos && <div className="create_record_input_group">
                    {/* ID = 1 Module id = 3*/}
                    <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="thirdparty">Where Did You Acquire It From?</label>
                        <Select
                            id="thirdparty"
                            size="small"
                            multiple
...

            {
                !add_primary_user_team && <div className="create_record_input_group">
                    ...
                    <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="primary_user_team">Who Is the Primary User or Department for This Asset?</label>
                        <Select
                            native
...

            {
                add_primary_user_team && <div className="create_record_input_group">
                    {/* ID = 1 Module id = 3*/}
                    <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="primary_user_or_team">Who Is the Primary User or Department for This Asset?</label>
                        <Select
            ...
            {
                !add_responsible_user_team && <div className="create_record_input_group">
                    {/* ID = 3 */}
                    <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="resposinble_user_team">Who is the User/Department responsible for managing this Asset?</label>
                        <Select
                            native
                            value={resposinble_user_team}
                            id="resposinble_user_team"
                            size="small"
                            onChange={(e) => setResponsibleUserTeam(e.target.value)}
                        >
                            <option aria-label="None" value="" />
                            <optgroup label="Users">
                                {
                        ...
                        {
                            !_.isEmpty(resposinble_user_team) ? <p style={{ color: '#ccc' }}>
                                Click here to add new User or Team
                            </p> : <Link className="chand" underline="none" onClick={() => setAddResponsibleUserTeam(true)}>
                                Click here to add new User or Team
                            </Link>
                        }
                    </FormControl>
...

            {
                add_responsible_user_team && <div className="create_record_input_group">
                    {/* ID = 1 Module id = 3*/}
                    <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="responsible_user_or_team">Who is the User/Department responsible for managing this Asset?</label>
                        <Select
                            id="responsible_user_or_team"
                            size="small"
                            value={responsible_user_or_team}
                            onChange={(e) => setResponsibleUserOrTeam(e.target.value)}
                        >
                            <MenuItem value="user">User</MenuItem>
                            <MenuItem value="team">Team</MenuItem>
                        </Select>

                        <Link className="chand" underline="none" onClick={() => setAddResponsibleUserTeam(false)}>
                            Click here to select existing User or Team
                        </Link>
                    </FormControl>
                    ...
                    <FormControl fullWidth sx={{ m: 1 }}>
                        ...
                        <TextField
                            ...
                            onChange={(e) => setResponsibleUserOrTeamName(e.target.value)}
                        />
                    </FormControl>
                </div>
            }
            ...
            <div className="create_record_input_group">
                {
                    !add_location && <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="hd_locations">What Is the Asset's Assigned Location?</label>
                        <Select
                            id="hd_locations"
                            size="small"
                            multiple
            ...
            <div className="create_record_input_group">
                {
                    !add_software && <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="software">What Operating System or Software Is Pre-Installed?</label>
                        <Select
                            id="software"
                            size="small"
                            multiple
                        ...
                        >
                            {
                                _.map(records, r => {
                                    return (r.module_id == 4) && (
                                        <MenuItem key={`software_${r.id}`} value={r.id}>
                                            <Checkbox checked={softwares.indexOf(r.id) > -1} />
                                            <ListItemText primary={r.name} />
                                        </MenuItem>
                                    )
                                })
                        ...
                        {
                            _.size(softwares) > 0 ? <p style={{ color: '#ccc' }}>
                                Click here to add new Software
...

                {
                    add_software && <FormControl fullWidth sx={{ m: 1 }}>
                        ...
                        <TextField
                            ...
                            onChange={(e) => setAddSoftwareName(e.target.value)}
                        />
                        <Link className="chand" underline="none" onClick={() => setAddSoftware(false)}>
                            Click here to select existing Softwares
                        </Link>
                    </FormControl>
                }
            </div>
            ...
            <div className="create_record_input_group">
                {
                    !add_infosysts && <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="infosysts">Is This Asset Part of a Larger Information System?</label>
                        <Select
                            id="infosysts"
                            size="small"
                            multiple
            ...
            <div className="create_record_input_group">
                {
                    !add_datasets && <FormControl fullWidth sx={{ m: 1 }}>
                        <label htmlFor="data-set">What Data Types Will This Hardware Process or Store?</label>
                        <Select
                            id="data-set"
                            size="small"
                            multiple
...
export default CreateHardwareRecord;