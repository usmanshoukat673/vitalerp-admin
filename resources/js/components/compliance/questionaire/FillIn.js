...
class FillIn extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            answer: (question.fill_in != null ? question.fill_in : ''),
    ...
    submitAnswer = () => {
        ...
        axiosInstance.post(`/api/user/compliance/answer/fill-in`, {
    ...
    render() {
        ...
        return (
            <Segment color='blue'>
                <div className="fill__in__quetion">
                    <div className="__radio__group">
                        ...
                        <Form>
                            <Form.Field>
                                ...
                                <Input placeholder='' disabled={!applicable} fluid className={this.handlerInputError(errors, 'answer')} onChange={this.handleChange} name="answer" value={answer} />
