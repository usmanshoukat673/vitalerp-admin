...
import { VerticalForm, FormInput } from '../../sub-components';
...
const ProjectList = ({ projectList, projects, company }) => {
    ...
    const getProjects = () => {
        ...
        if (_.size(projects) > 0) {
                ...
                <Card className="mb-0 h-100">
                    <Card.Body>
                        <CardTitle
                            ...
                            title={
                                <div>
                                    <h4 className="header-title">{projects[0].title}</h4>
                                    <h5
                        ...
                        <div className="d-flex align-items-center mt-3">
                            <div className="flex-shrink-0">
                                <h5 className="font-13 text-muted my-0">
                                    <i className="mdi mdi-clock-outline"></i> {`${showTZDate(projects[0].created_at, company.timezone)}`}
                                </h5>
                            </div>
            ...
            <Col sm={6} xl={3} className="mb-3">{
                (!_.isEmpty(projects[1])) && <Card className="mb-0 h-100">
                    <Card.Body>
                        <CardTitle
                            containerClass="d-flex align-items-center justify-content-between"
                            title={
                                <div>
                                    <h4 className="header-title">{projects[1].title}</h4>
                                    <h5
                                        className="text-muted fw-normal mt-0 text-truncate"
                                        title="Campaign Sent">
                                    </h5>
                        ...
                        <div className="d-flex align-items-center mt-3">
                            <div className="flex-shrink-0">
                                <h5 className="font-13 text-muted my-0">
                                    <i className="mdi mdi-clock-outline"></i> {`${showTZDate(projects[1].created_at, company.timezone)}`}
                                </h5>
                            </div>
                            <div className="flex-grow-1 ms-2"></div>
                        </div>
            ...
            <Col sm={6} xl={3} className="mb-3">   {
                (!_.isEmpty(projects[2])) && <Card className="mb-0 h-100">
                    <Card.Body>
                        <CardTitle
                            containerClass="d-flex align-items-center justify-content-between"
                            title={
                                <div>
                                    <h4 className="header-title">{projects[2].title}</h4>
                                    <h5
                                        className="text-muted fw-normal mt-0 text-truncate"
                                        title="Campaign Sent">
                                    </h5>
                        ...
                        <div className="d-flex align-items-center mt-3">
                            <div className="flex-shrink-0">
                                <h5 className="font-13 text-muted my-0">
                                    <i className="mdi mdi-clock-outline"></i> {`${showTZDate(projects[2].created_at, company.timezone)}`}
                                </h5>
                            </div>
                            <div className="flex-grow-1 ms-2"></div>
                        </div>
