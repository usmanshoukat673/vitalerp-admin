...
import SubAssetInfo from './SubAssetInfo';
import CreateRecordsFS from "../../record/CreateRecordsFS";
import AddRecordButton from "../../record/AddRecordButton";

const ThirdPartyDetailsPanel = ({ history, match }) => {
    ...
    useEffect(() => {
        ...
        const expectedPath = `/third-parties/:category`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/third-parties/:category/:parent_asset`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/third-parties/:category/:parent_asset/:child_asset`;
    ...
    const handleLanParentAssetNav = () => {
        dispatch(selectLanDetailsPanelType('parent_asset'));
        history.push(`/third-parties/${category.slug}/${parent_asset.id}`);
    }

     const handleLanCategoryNav = () => {
        dispatch(selectLanDetailsPanelType('category'));
        history.push(`/third-parties/${category.slug}`);
    }
    ...
    const LanBreadcrum = () => {
        return (
            <div className="cs_breadcrum">
                ...
                <span className="_active" onClick={handleLanNavigateion} >Third Parties</span> {' > '}
...
export default withRouter(ThirdPartyDetailsPanel);