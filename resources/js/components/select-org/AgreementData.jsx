...
const AgreementData = ({ onClickHandler }) => {
    return (
        
        <div className='__policy__page' style={{ marginTop: '0', paddingTop: '0' }}>

            <p><strong>Effective Date:</strong> Sept, 20, 2024</p>
            <p><strong>Company Name:</strong> decypher</p>
            <p><strong>Service:</strong> VitalERP</p>
            ...
            <div className='__page__content' role="article" style={{ hyphens: 'auto', overflowWrap: 'break-word', textAlign: 'justify' }}>
                ...
                <section name="services">
                    <div className='__sub__intro'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>AGREEMENT TO OUR LEGAL TERMS</h3>
                ...
                <section name="intellectual_property" className='pt-3'>
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>INTELLECTUAL PROPERTY RIGHTS</h3>
                    </div>
                ...
                <section name="user_representations">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>USER REPRESENTATIONS</h3>
                    </div>
                    <p>
                ...
                <section name="prohibited_activities">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>PROHIBITED ACTIVITIES</h3>
                    </div>
                    <p>
                ...
                <section name="user_generated_contributions">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>USER GENERATED CONTRIBUTIONS</h3>
                    </div>
                    <p>
                ...
                <section name="contribution_license">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>CONTRIBUTION LICENSE</h3>
                    </div>
                    <p>
                ...
                <section name="third_party_content">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>THIRD-PARTY WEBSITES AND CONTENT</h3>
                    </div>
                    <p>
                ...
                <section name="services_management">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>SERVICES MANAGEMENT</h3>
                    </div>
                    <p>
                ...
                <section name="privacy_policy">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>PRIVACY POLICY</h3>
                    </div>
                    <p>
                ...
                <section name="copyright_infringements">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>COPYRIGHT INFRINGEMENTS</h3>
                    </div>
                    <p>
                ...
                <section name="term_and_termination">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>TERM AND TERMINATION</h3>
                    </div>
                    <p>
                ...
                <section name="modifications_interruptions">
                    <div className='__section__heading'>
                        <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>MODIFICATIONS AND INTERRUPTIONS</h3>
                        </div>
                        <p>
                ...
                <section name="governing_law">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>GOVERNING LAW</h3>
                    </div>
                    <p>
                ...
                <section name="dispute_resolution">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>DISPUTE RESOLUTION</h3>
                    </div>
                ...
                <section name="corrections">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>CORRECTIONS</h3>
                    </div>
                    <p>
                ...
                <section name="disclaimer">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>                        DISCLAIMER</h3>
                    </div>
                    <p>
                ...
                <section name="limitations_of_liability">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>LIMITATIONS OF LIABILITY</h3>
                    </div>
                    <p>
                ...
                <section name="indemnification">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>INDEMNIFICATION</h3>
                    </div>
                    <p>
                ...
                <section name="about_customer_user">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>USER DATA</h3>
                    </div>
                    <p>
                ...
                <section name="electronic_communications">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
                    </div>
                    <p>
                ...
                <section name="sms_text_messaging">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>SMS TEXT MESSAGING</h3>
                    </div>
                ...
                <section name="california_users">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>CALIFORNIA USERS AND RESIDENTS</h3>
                    </div>
                    <p>
                ...
                <section name="miscellaneous">
                    <div className='__section__heading'>
                        <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>MISCELLANEOUS</h3>
                    </div>
                    <p>
                ...
                <section name="contact_us">
                    <div className='__section__heading'>
                    <h3 style={{ fontWeight: 'bold', paddingTop: '20px' }}>CONTACT US</h3>
                    </div>
                    <p>
