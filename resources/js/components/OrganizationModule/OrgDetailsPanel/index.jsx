...
const OrgDetailsPanel = ({ history, match }) => {
    ...
    useEffect(() => {
        ...
        const expectedPath = `/organization/:category`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/organization/:category/:parent_asset`;
    ...
    useEffect(() => {
        // Your logic to compare with the specified path
        const expectedPath = `/organization/:category/:parent_asset/:child_asset`;
    ...
    const handleLanParentAssetNav = () => {
        ...
        history.push(`/organization/${category.slug}/${parent_asset.id}`);
    }

    const handleLanCategoryNav = () => {
        dispatch(selectLanDetailsPanelType('category'));
        history.push(`/organization/${category.slug}`);
    }
                ...
                {details_panel_type === 'category' && <>
                    <LoadingBackgrop open={loading_category} />
                    {
                        !loading_category && <>
                            ...
                            <div className="cs_breadcrum">
                                <VisitDashboardBreadcrum /> {' > '}
                                <span className="_active" onClick={handleLanNavigateion} >Organization</span> {' > '}
...
export default withRouter(OrgDetailsPanel);